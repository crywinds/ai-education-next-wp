...
export default function ServicesPage() {
  ...
  const serviceData = generateStructuredData({
    type: 'Service',
    title: '網店 + 批發服務',
    description: 'Korae 提供可選的網店 + 批發服務，包括完整網店系統、每週更新過千款批發貨源、專業網店設計、品質檢查服務、物流配送支援。',
  ...
  const serviceFeatures = [
    {
      icon: '📥',
      title: '數據下載功能（核心）',
      description: '支援 CSV、Excel、JSON 格式，批量下載商品數據，相容 Shopify、WooCommerce、Shopline、Shopage 等平台（付費會員專享）',
    },
    {
      icon: '📦',
      title: '批發貨源',
  ...
  const faqs = [
    {
      question: '網店服務是強制性的嗎？',
      answer: '不是。網店服務是可選的，客戶無需強制綁定。我們提供純批發服務，您可以選擇下載商品數據匯入您現有的 Shopify、WooCommerce、Shopline、Shopage 或其他電商平台。',
    },
    {
    ...
    },
    {
      ...
      answer: 'Korae 支援 CSV、Excel、JSON 三種數據格式下載。下載的數據包含商品圖片、描述、價格、庫存等完整資訊，可輕鬆匯入 Shopify、WooCommerce、Shopline、Shopage 或其他電商平台。',
    },
    {
      question: '網店系統包含哪些功能？',
    ...
    {
      question: '如何選擇適合我的服務？',
      answer: '如果您已有網店系統（如 Shopify、WooCommerce、Shopline、Shopage），建議選擇純批發服務，下載商品數據匯入您現有的平台。如果您需要完整的網店解決方案，可以選擇網店 + 批發服務。',
    },
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-12 sm:py-16 md:py-20 bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            <div className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6">
              可選服務
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 sm:mb-6 text-slate-900 dark:text-white px-2">
              網店 + 批發服務
              <br />
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-600 dark:text-slate-300 leading-relaxed mb-6 sm:mb-8 px-2">
              如果您需要網店系統，我們也提供可選的網店服務。客戶可自由選擇，無需強制綁定。我們也提供純批發服務，讓您下載商品數據匯入您現有的銷售渠道。
            </p>
            <Link
              href="#apply"
              className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 active:from-blue-800 active:to-cyan-800 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all text-sm sm:text-base touch-manipulation"
            >
              線上申請
              ...
              <div className="flex overflow-x-auto scrollbar-hide">
                {tabs.map((tab) => (
                  <button
                    ...
                    className={`px-3 sm:px-4 py-3 sm:py-4 text-xs sm:text-sm font-medium whitespace-nowrap transition-colors touch-manipulation ${
                      activeTab === tab.id
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8 sm:mb-12">
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-3 sm:mb-4">服務介紹</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12">
                <div>
                  <h3 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white mb-3 sm:mb-4">可選的網店服務</h3>
                  <p className="text-sm sm:text-base md:text-lg text-slate-600 dark:text-slate-300 leading-relaxed mb-3 sm:mb-4">
                  ...
                  <Link
                    href="/wholesale"
                    className="inline-flex items-center px-5 sm:px-6 py-2.5 sm:py-3 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all text-sm sm:text-base touch-manipulation"
                  >
                    了解純批發服務
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-6xl mx-auto">
              {pricingPlans.map((plan, index) => (
                <motion.div
                  ...
                  transition={{ delay: index * 0.1 }}
                  whileHover={{ y: -5, scale: 1.02 }}
                  className={`relative rounded-2xl p-5 sm:p-6 md:p-8 shadow-lg hover:shadow-xl transition-all border-2 ${
                    plan.popular
                      ? 'bg-gradient-to-br from-blue-600 to-cyan-600 text-white border-blue-500 sm:scale-105'
                      : 'bg-white border-slate-200'
                  }`}
                >
                  {plan.popular && (
                    <div className="absolute -top-3 sm:-top-4 left-1/2 transform -translate-x-1/2 px-3 sm:px-4 py-1 bg-amber-400 text-amber-900 rounded-full text-xs sm:text-sm font-semibold">
                      最受歡迎
                    </div>
                  )}
                  <div className="text-center mb-4 sm:mb-6">
                    <h3 className={`text-xl sm:text-2xl font-bold mb-2 ${plan.popular ? 'text-white' : 'text-slate-900'}`}>
                      {plan.name}
                    </h3>
                    <div className="mb-2">
                      {plan.customPrice ? (
                        <span className={`text-2xl font-bold ${plan.popular ? 'text-white' : 'text-slate-900'}`}>
                          {plan.price}
                        </span>
                      ) : (
                        <>
